      ...
      <div className="relative isolate px-6 pt-14 lg:px-8">
        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          <div className="hidden sm:mb-8 sm:flex sm:justify-center">
            <div className="relative rounded-full px-3 py-1 text-sm leading-6 text-white ring-1 ring-gray-600 hover:ring-gray-400">
          ...
          <div className="text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-300 max-w-xl mx-auto">
              Improve your technical skills by leveraging educational content
              and engaging in a community of developers.
            </p>
